    ...
    <div className="bookingroom-container">
      ...
      <div className="bookingroom-description-slider-container">
        ...
        <div className="bookingroom-additional-images">
          <img src="sub-room-2.png" alt="Cozy hotel bar" className="bookingroom-additional-image" />
          <img src="sub-room-3.png" alt="Swimming pool" className="bookingroom-additional-image" />
          <img src="sub-room-4.png" alt="Casino area" className="bookingroom-additional-image" />
        </div>
